...
show_vps_info() {
    ...
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e "\e[1;34m                    TRIDNS V4V6                   \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
...
show_cpu_ram_info() {
    ...
    echo -e "\e[1;34m                  TRIDNS CPU | RAM INFO          \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
...
show_menu() {
    ...
    echo -e "\e[1;34m                  TRIDNS MENU                     \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e ""
    ...
    echo -e "\e[1;32m SCRIPT NAME   \e[0m: Tridns"
    echo -e "\e[1;32m MADE BY     \e[0m: Tinukierl"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e ""
